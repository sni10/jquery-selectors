...
// Так же селекторы можно группировать multiple selectors:
$('div, span, #getForm');          // выбор всех div и span элементов
...
// Для работы с элементами форм есть ряд селекторов позволяющий 
// выбирать по типу элемента и фильтров - enabled/disabled/selected/checked :
